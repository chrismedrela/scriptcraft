...
class Environment(object):
    ...
    def create_file(self, path, data):
        ...
        self._create_temporary_folder_if_necessary(path_without_filename)
    ...
    def execute_bash_command(self, command, input_data):
    ...
    def _create_temporary_folder_if_necessary(self, folder_path):
        folder_path = self._get_path_as_iterable(folder_path)

        full_path = []
        for folder in folder_path:
            full_path.append(folder)
            path = self._get_path(full_path)
