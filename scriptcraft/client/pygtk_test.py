...
class GameViewer(gtk.DrawingArea):
    ...
    def _expose_callback(self, area, event):
        ...
        print 'redrawing in', time.time()-t, 'sec'
        return True
    ...
    def _get_scaled_sprite(self, name):
        ...
        #import time
        #t = time.time()
        scaled = sprite.scale_simple(new_width, new_height, gtk.gdk.INTERP_NEAREST) #gtk.gdk.INTERP_BILINEAR)
        #print 'scaling', time.time()-t, 'sek'
